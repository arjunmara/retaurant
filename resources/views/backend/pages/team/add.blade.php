                    ...
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        ...
                        <div id="myTabContent" class="tab-content">
                            <div role="tabpanel" class="tab-pane fade " id="profile" aria-labelledby="home-tab">
                                ...
                                <form class="form-horizontal form-label-left" method="post" action="{{route('admin-team-action')}}" enctype="multipart/form-data" style="color:darkslategrey;width:1200px;">
                                    {{csrf_field()}}
                                    ...
                                    <div class="col-md-12 col-lg-12 col-xs-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <textarea class="form-control" value=""  name="details" style="height:100px;"></textarea>
                                            </div>
