            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel" style="color:white;background-color: #333333">
                    ...
                    <div class="x_title">
                        ...
                        <h2><i class="fa fa-tags"></i>Site-Image_slider&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title"><center style="color:black;">Add_Image</center></h4>
                                    </div>
                                    <div class="modal-body">

                                        <form action="{{route('admin-slider-action')}}" method="post" enctype="multipart/form-data" style="color:black">
                                            ...
                                            {{csrf_field()}}
                                                 ...
                                                 <div class="form-group col-md-12" >
                                                   ...
                                                   <input type="text" class="form-control" required name="title_1">
                                                </div>

                                                <div class="form-group col-md-12">
                                                    <label class="form-group">Title-2:</label>
                                                    <input type="text" class="form-control" required name="title_2">
                                                </div>
                                ...
                                <div class="card-container" >
                                    <div class="card">
                                        <div class="card-image">
                                            <img src="{{URL::to('frontend/image/slider/'.$data->image)}}" alt="" style="height:300px;width:400px;"/>
                                        </div>
                                        <div class="card-info">
                                            <div class="card-title"></div>
                                            <div class="card-detail">
                                                <h5>{{$data->title_1}}</h5><br>
                                                <h5>{{$data->title_2}}</h5>
                                        ...
                                        <div class="card-social">
                                            <ul>
                                                ...
                                                <form method="post" action="{{route('admin-slider-delete',['id'=>$data->id])}}">
                                                    <li>
                                                        {{csrf_field()}}
